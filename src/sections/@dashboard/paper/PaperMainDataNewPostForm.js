...
export default function PaperMainDataNewPostForm() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // blog create
      const slug = encodeURI(kebabCase(data.title));
      ...
      await setDoc(blogRef, {
        ...
        // content : data.content, // TODO save reference link
        // cover : data.cover // TODO save reference link
        tags: data.tags,
